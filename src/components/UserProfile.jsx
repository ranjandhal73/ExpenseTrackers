...
function UserProfile({ onClose }) {
    ...
    const handlePhotoUpload = async (e) => {
        ...
        reader.onloadend = () => {
            ...
            // Optionally update the user's profile with the new photo URL
            ...
            <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-1/2 lg:w-1/3 p-4 relative">
                ...
                <div className="mt-4">
                    <div className="text-sm md:text-lg">
                        ...
                        <div className="flex flex-col md:flex-row gap-2 md:gap-5 mb-2">
                            <p>Email: {user.email}</p>
                            <div>
                                {user.emailVerified ? 
                                    <p className="text-sky-400">Verified</p> : 
